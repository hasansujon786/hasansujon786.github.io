...
const ScrollDown = (props: ProspWithClassName) => {
  return (
    <div className={cn('flex animate-bounce flex-col items-center justify-center', props.className)}>
      <div className='mb-0.5 text-sm font-semibold'>Scroll</div>
      ...
      <FiChevronDown className='mt-0.5 text-lg' />
    </div>
  )
}
